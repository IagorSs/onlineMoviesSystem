...
//select * from (select usuario.nome, filme_assistido.id_filme from usuario 
//	join filme_assistido on usuario.inscricao = filme_assistido.inscricao_usuario) as assistidos
//	where assistidos.id_filme = 5;