...
module.exports = {
    atualizar: async (req, res) => {
        try {
            ...
            const response = await atualizarFilmeService.atualizar(id, categoria, duracao, nome, produtora, arquivo, image_url, video_url, descricao, id_ator_principal, id_diretor)
